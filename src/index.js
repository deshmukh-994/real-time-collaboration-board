...
const boards = {}; // in-memory { boardId: { id, name, items: [] } }

app.get('/health', (req, res) => {
  res.json({ status: 'ok', service: 'real-time-collaboration-board-backend' });
});
...
server.listen(PORT, () => {
  console.log(`Real-Time Collaboration Board backend listening on port ${PORT}`);
});
